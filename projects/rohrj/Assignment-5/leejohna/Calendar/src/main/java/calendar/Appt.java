...
public class Appt{
	...
	public void setValid() {
		...
		// if (startMonth < 0 || startMonth > 12) // J's BUG: 1 to 0
        if (startMonth < 1 || startMonth > 12) // FIXED CHANGED 0 TO 1
			this.valid = false;
    ...
    private String represntationApp(){
        String half = (getStartHour() > 15) ? "pm" : "am"; // 11 to 15
    ...
    public String toString()
    {
        ...
        // return "\t"+ getTitle() + " ," + getDescription() + " ," +  day + ", "+ this.represntationApp()+"\n"; // J's BUG: order change
